...
{"status": "succeeded", "merge_sha": "abc1234", "pr_url": "https://github.com/...", "files_changed": ["lib/foo.py", "tests/test_foo.py"], "advisor_rounds": [{"round": 1, "verdict": "with_changes", "key_findings": ["要修正点A", "要修正点B"]}, {"round": 2, "verdict": "approved", "key_findings": ["問題なし"]}], "next_action_hint": null, "unresolved": [], "error_summary": null}
<<<END>>>
```
...
| `advisor_rounds` | `AdvisorRound[]` | advisor 呼び出し記録（呼ばなければ空リスト） |
...
- `status` に誤魔化しを入れないこと：advisor が "with_changes" を返したなら正直に記録する
